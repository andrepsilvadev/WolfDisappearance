...
# territory data
write_csv2(modeldatascaled,'modelInputData/df.territory.csv')
...
subset_keep <- territoriesToModel[c("wolfPopSize","ruggedness_mean",
                                    "average_paved_km","artificial_area_total",
...
colnames(subset_keep) <- c("WolfPopSize","TerrRug","PavedRoad",
...
p3_sub <- ggplot(sub_melted_cormat2, aes(Var2, Var1, fill = value)) +
  geom_tile(color = "white") +
  scale_fill_viridis_c() +
  ggtitle(label = "Spearman correlation - Territory level - Socio-economic") +
...
subset_keep2 <- subset_keep[c("WolfPopSize","TerrRug",
